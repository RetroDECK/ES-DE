...
if exist SDL2-2.28.3\ (
  rmdir /S /Q SDL2-2.28.3
)
...
if exist SDL2-devel-2.28.3-VC.zip (
  del SDL2-devel-2.28.3-VC.zip
)

curl -LO https://libsdl.org/release/SDL2-devel-2.28.3-VC.zip

7z x SDL2-devel-2.28.3-VC.zip

if not exist SDL2-2.28.3\ (
  echo SDL directory is missing, aborting.
  cd ..
  goto end
)

rename SDL2-2.28.3 SDL2
