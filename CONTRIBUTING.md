...
* Helping with user support in our Discord server and on our subreddit
* Packaging for additional Linux distributions

Note that we are however not looking for collaborating on the C++ development at this moment in time.
