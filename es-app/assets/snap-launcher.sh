...
#  snap-launcher.sh
#
#  Initialization script for launching ES-DE from a Snap package.
#  This is a combination of the "desktop-exports", "init" and "mark-and-exec" scripts found here:
#  https://github.com/ubuntu/snapcraft-desktop-helpers/tree/master/common
#
...
env
exec strace /var/lib/snapd/snap/emulationstation/current/usr/bin/emulationstation $@
