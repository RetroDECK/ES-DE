...
| apple2                | Apple II                                       |                                   |                                   |         |                                      |
| apple2gs              | Apple IIGS                                     |                                   |                                   |         |                                      |
| arcade                | Arcade                                         | MAME - Current (RetroArch)        | MAME 2000 (RetroArch) <br> MAME 2003-Plus (RetroArch) <br> MAME 2010 (RetroArch) | Depends | Single archive file following MAME name standard in root folder |
...
| mame                  | Multiple Arcade Machine Emulator               | MAME 2003-Plus (RetroArch)        | MAME 2000 (RetroArch) <br> MAME 2010 (RetroArch) <br> MAME - Current (RetroArch) | Depends | Single archive file following MAME name standard in root folder |
