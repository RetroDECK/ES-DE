...
if exist SDL2-2.28.1\ (
  rmdir /S /Q SDL2-2.28.1
)
...
if exist SDL2-devel-2.28.1-VC.zip (
  del SDL2-devel-2.28.1-VC.zip
)

curl -LO https://libsdl.org/release/SDL2-devel-2.28.1-VC.zip

7z x SDL2-devel-2.28.1-VC.zip

if not exist SDL2-2.28.1\ (
  echo SDL directory is missing, aborting.
  cd ..
  goto end
)

rename SDL2-2.28.1 SDL2
